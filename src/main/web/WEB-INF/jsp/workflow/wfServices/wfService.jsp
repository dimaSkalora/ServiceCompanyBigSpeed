...
<div class="jumbotron">
    <div class="container">
        <c:url var="createOrUpdateUrl" value="/wfServices/createOrUpdate" />
        <form:form method="POST" modelAttribute="wfService" action="${createOrUpdateUrl}">
            ...
            <footer>
                ...
                <c:set var="jsf_request_uriStr" value="/ServiceCompanyBigSpeed/wfServices/get"/>
                <c:if test="${jsf_request_uri.startsWith(jsf_request_uriStr)}">
                    <a href="/ServiceCompanyBigSpeed/wfServices"><spring:message code="app.ok"/></a>
                </c:if>
                <c:if test="${!jsf_request_uri.startsWith(jsf_request_uriStr)}">
