...
<div class="jumbotron">
    <div class="container">
        <c:url var="createOrUpdateUrl" value="/wfBaseProcessTypes/createOrUpdate" />
        <form:form method="POST" modelAttribute="wfBaseProcessType" action="${createOrUpdateUrl}">
            ...
            <footer>
                ...
                <c:set var="jsf_request_uriStr" value="/ServiceCompanyBigSpeed/wfBaseProcessTypes/get"/>
                <c:if test="${jsf_request_uri.startsWith(jsf_request_uriStr)}">
                    <a href="/ServiceCompanyBigSpeed/wfBaseProcessTypes"><spring:message code="app.ok"/></a>
                </c:if>
                <c:if test="${!jsf_request_uri.startsWith(jsf_request_uriStr)}">
