...
<div class="jumbotron">
    <div class="container">
        <c:url var="createOrUpdateUrl" value="/roles/createOrUpdate" />
        <form:form method="POST" modelAttribute="role" action="${createOrUpdateUrl}">
            <fieldset>
                <table>
                    <tr>
                        <td>
            ...
            <footer>
                ...
                <c:set var="jsf_request_uriStr" value="/ServiceCompanyBigSpeed/roles/get"/>
                <c:if test="${jsf_request_uri.startsWith(jsf_request_uriStr)}">
                    <a href="/ServiceCompanyBigSpeed/roles"><spring:message code="app.ok"/></a>
                </c:if>
                <c:if test="${!jsf_request_uri.startsWith(jsf_request_uriStr)}">
