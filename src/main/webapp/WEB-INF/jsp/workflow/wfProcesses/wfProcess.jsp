...
<div class="jumbotron">
    <div class="container">
        <c:url var="createOrUpdateUrl" value="/workflow/wfProcesses/createOrUpdate" />
        <form:form method="POST" modelAttribute="wfProcess" action="${createOrUpdateUrl}">
            ...
            <footer>
                ...
                <c:set var="jsf_request_uriStr" value="/ServiceCompanyBigSpeed/workflow/wfProcesses/get"/>
                <c:if test="${jsf_request_uri.startsWith(jsf_request_uriStr)}">
                    <a href="/ServiceCompanyBigSpeed/workflow/wfProcesses"><spring:message code="app.ok"/></a>
                </c:if>
                <c:if test="${!jsf_request_uri.startsWith(jsf_request_uriStr)}">
