...
<div class="jumbotron">
    <div class="container">
        <c:url var="createOrUpdateUrl" value="/workflow/wfBaseProcessTypes/createOrUpdate" />
        <form:form method="POST" modelAttribute="wfBaseProcessType" action="${createOrUpdateUrl}">
            <fieldset>
                <table>
                    <tr>
                        <td>
            ...
            <footer>
                ...
                <c:set var="jsf_request_uriStr" value="/ServiceCompanyBigSpeed/workflow/wfBaseProcessTypes/get"/>
                <c:if test="${jsf_request_uri.startsWith(jsf_request_uriStr)}">
                    <a href="/ServiceCompanyBigSpeed/workflow/wfBaseProcessTypes"><spring:message code="app.ok"/></a>
                </c:if>
                <c:if test="${!jsf_request_uri.startsWith(jsf_request_uriStr)}">
                    <c:if test="${!empty wfBaseProcessType.id}">
