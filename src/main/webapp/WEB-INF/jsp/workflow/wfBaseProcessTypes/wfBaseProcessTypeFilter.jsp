...
<head>
    <title>WorkFlow Base Process Type Filter</title>
</head>
<body>
    ...
    <div class="container">
        ...
        <form method="post" action="${createOrUpdateUrl}" >
            <table border="0" cellpadding="8" cellspacing="0">
                <tr>
                    <td><spring:message code="workflow.wfBaseProcessType.id"/></td>
                    <td><input type="number" name="id" value="${param.id}"></td>
                    <td><spring:message code="workflow.wfBaseProcessType.name"/></td>
