...
public class RestWFProcessStateController extends AbstractWFProcessStateController{
    ...
    public ResponseEntity<WFProcessState> createWithLocation(@Valid @RequestBody WFProcessState wfProcessState){
    ...
    public ResponseEntity<WFProcessState> updateWFPS(@Valid@RequestBody WFProcessState wfProcessState, @PathVariable("id") int id){
        WFProcessState updated = super.update(wfProcessState, id);
